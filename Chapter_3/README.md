...
2. The image and text output files end with "*_with_output.ipynb."
  ...
  - Use NBViewer to preview: https://nbviewer.org/github/PacktPublishing/Data-Augmentation-with-Python/blob/main/Chapter_3/data_augmentation_with_python_chapter_3_with_output.ipynb
